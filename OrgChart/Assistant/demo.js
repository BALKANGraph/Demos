window.onload = function () {
    var chart = new OrgChart(document.getElementById("tree"), {
        ...
        nodes: [
            ...
            { id: 3, pid: 1, tags: "RR", name: "Caden Ellison", title: "Dev Manager", img: "https://balkangraph.com/js/img/4.jpg" },
            ...
            { id: 9, pid: 2, tags: ["assistant"], name: "Skyler Hunt", title: "Assistant", img: "https://balkangraph.com/js/img/12.jpg" }
        ]
    });
};